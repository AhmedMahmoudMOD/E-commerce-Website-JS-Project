...
function LoadData() // Load the products information to the cart page
{
    ...
    Data.forEach(Product => {
        ...
        document.getElementById("cart-items").innerText = `LE ${items.toFixed(2)}`; // Add the total items price to the cart
        document.getElementById("cart-total").innerText = `LE ${total.toFixed(2)}`; // Add the total price to the cart
    });
}
